(define (domain wumpus)
  ...
  (:action pushCrateEast
      :parameters (?s - agent ?o1 - pushable ?c - crate ?l1 - location ?l2 - location ?l3 - location ?p - pit)
      :precondition (and 
          (at ?s ?l1)
          (adjacent_east ?l1 ?l2)
          (at ?o1 ?l2)
      ...
      :effect (and
          ...
          ;; Possible Error
          ;; SITUATION_4: Filled Pit
          (when (and (at ?p ?l3) (filledPit ?l3)) 
              (and 
                  (at ?s ?l2) 
                  (not (at ?s ?l1)) 
                  (empty ?l1)
  ...
  (:action pushCrateWest
      :parameters (?s - agent ?c - crate ?l1 - location ?l2 - location ?l3 - location ?p - pit)
      :precondition (and 
          (at ?s ?l1)
          (adjacent_west ?l1 ?l2)
          (at ?c ?l2)
  ...
  (:action pushHalfCrateEast
      :parameters (?s - agent ?h - halfCrate ?l1 - location ?l2 - location ?l3 - location ?p - pit)
      :precondition (and 
          (at ?s ?l1)
          (adjacent_east ?l1 ?l2)
          (at ?h ?l2)
