...
example_problems_dir = r'E:\Collage\Semester-4\AI-SysProject\Problem_5\project\assignment\example-maps'

# Output folder location
output_folder_location = r'E:\Collage\Semester-4\AI-SysProject\Problem_5\project\assignment\my-example-solution'

# Iterate over each example problem file
for example_problem_file in os.listdir(example_problems_dir):
    if example_problem_file.endswith('.txt'):
        ...
        map_txt_file_path = os.path.join(example_problems_dir, example_problem_file)
        output_folder = os.path.join(output_folder_location, problem_number)
        os.makedirs(output_folder, exist_ok=True)
        map_pddl_file_path = os.path.join(output_folder, 'map.pddl')
        ...
        shutil.copy(r'E:\Collage\Semester-4\AI-SysProject\Problem_5\project\assignment\my-example-solution\map.pddl', map_pddl_file_path)
        ...
        print(f"Content inserted successfully into {map_pddl_file_path}")
